...
<form method="post" action="/customer/${customer.customer_id}">
    ...
    <div>
        ...
        <input type="password" value="${customer.pass}" name="pass" id="pass"/>
    </div>
    <br>
    <div>
            ...
            <select name="addressId" id="address" >
                ...
                <#list allAddress as address>
                    <option <#if customer.address?? && customer.address.address_id == address.address_id>selected</#if>
                            value="${address.address_id}">${address.city}, ${address.country}, ${address.state}</option>
                </#list>
    ...
    <table border="1">
        ...
        <#list allPaidType as paidType>
            <tr>
                ...
                <td><label>
                        <input type="checkbox" name="paidTypeChoose" value="${paidType.paid_type_id }"
